...
def train(args):
    ...
    train_data, test_data ,num_classes = create_data_loader(args.train_dir, args.test_dir, batch_size=args.batch_size )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--batch_size",type=int, default=64,help="adjust the number with with your VRAM size ") 
